  ...
  def dump_db
    if params.has_key? :patients
      patients = CSV.generate do |csv|
        csv << %w[bp name first_name second_name phone rest trasnportation latitude longitude vehicle_type comuna address travels_type medic kine comment reference_attention_time employ emergency_type]
